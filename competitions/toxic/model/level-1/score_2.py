...
f = open('../data/data/fasttext/fasttext.txt')
skip = True
...
def dataflow(train_text, valid_text, score_text):
    ...
    tokenizer = text.Tokenizer(lower=True, char_level=False)
...
submit.to_csv('../data/submit/model_3.csv', index=False)
...
submit.to_csv('../data/model/model_3.csv', index=False)
