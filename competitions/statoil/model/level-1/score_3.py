...
from keras.layers import AveragePooling2D, GaussianDropout
...
scores.to_csv('../data/submit/vgg16_v1.csv', index=False)
...
crossfolds.to_csv('../data/model/vgg16_v1.csv', index=False)