...
merge('scores/cnn_1.csv', 'model_1')
merge('scores/cnn_2.csv', 'model_2')
...
train_data.to_csv('../data/insample/scores/cnn_3.csv', index=False)
test_data.to_csv('../data/outsample/scores/cnn_3.csv', index=False)