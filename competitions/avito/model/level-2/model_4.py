...
f = open('../data/data/neural/embed/fasttext.vec')
...
def callbacks(mode):
    ...
    logger = CSVLogger('../data/data/neural/model_1/logger_{}.log'.format(mode))
    best = ModelCheckpoint('../data/data/neural/model_1/weights_{}.h5'.format(mode), save_best_only=True)
